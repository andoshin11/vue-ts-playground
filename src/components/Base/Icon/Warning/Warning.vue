	 ...
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
		<g>
			<path d="M507.113,428.415L287.215,47.541c-6.515-11.285-18.184-18.022-31.215-18.022c-13.031,0-24.7,6.737-31.215,18.022
				...
				C482.61,446.047,481.748,448.32,481.101,449.441z" :fill="fill"/>
			<rect x="240.987" y="166.095" width="30.037" height="160.197" :fill="fill" />
			<circle cx="256.005" cy="376.354" r="20.025" :fill="fill" />
		</g>
  </svg>
</template>
