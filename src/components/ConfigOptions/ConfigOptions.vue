...
import {
  optionsSummary,
  OptionsSummary
} from "@/lib/playground/const/optionsSummary";
...
export default Vue.extend({
  ...
  computed: {
    ...
    boolOptions(): OptionsSummary[] {
      const { compilerOptions } = this;
      const boolOptions = optionsSummary.filter(
        k => typeof compilerOptions![k.id] === "boolean"
      );
